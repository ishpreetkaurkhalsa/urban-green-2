...
const Hero = () => {
    ...
    <div id="hero2" className="flex flex-col lg:flex-row py-10 justify-between text-center lg:text-left">
        <div className="lg:w-2/2 flex flex-col justify-center mt-9 align-middle">
            ...
            <HashLink id="signupButton" className="text-black border border-solid border-black hover:bg-[#57d08e] inline-flex items-center justify-center w-auto px-5 py-2 shadow-xl rounded-xl" smooth to="/landlord">
                Become Landlord
            </HashLink>
            </div>
        </div>
